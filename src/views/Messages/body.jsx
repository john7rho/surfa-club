...
export default class Body extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      chats: [
        {
          label: 'you: bet ima be there next weekend',
          name: 'Lumia Noella',
          date: '9/3/2022',
          profil: Profil2,
          data: [
            {
              ...
              messages: [
                {
                  is_contact: true,
                  text: 'blah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blah ?',
                },
                {
                  is_contact: false,
                  text: 'yes very nice blah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blah',
                },
              ],
            },
            {
              ...
              messages: [
                { is_contact: true, text: 'come to berkeley bro' },
                { is_contact: false, text: 'bet ima be there next weekend' },
              ],
            },
          ],
        },
   ...
   * @return: void
   */
  __set_active_contact_index = (new_index) =>
  ...
  __send_message = (datetime, is_contact, message) => {
    // Gets chats data.
    let chats = lodash.cloneDeep(this.state.chats),
    ...
    if (index > -1)
      chats[this.state.active_index].data[index].messages.push({
        is_contact: is_contact,
        text: message,
      });
    // Adds the current message with the given datetime for today.
    else
      chats[this.state.active_index].data.push({
    ...
    <div className='chat-workspace'>
      ...
      <div className='chat-container'>
        ...
        <Contacts
          ...
          chatContext={this.chat_context.current}
        ...
        <div className='messages-workspace'>
          ...
          <ChatMessagesHeader
            contact={this.state.chats[this.state.active_index]}
          />
          {/* Chat context */}
          <ChatContext
            chats={this.state.chats[this.state.active_index].data}
            userProfil={Profil1}
            contactProfil={this.state.chats[this.state.active_index].profil}
            ref={this.chat_context}
          />
          {/* Message editor */}
