...
export default class Header extends React.PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            suggestions: [
                { left_icon: LoopIcon, text: 'John Rho', on_select: ref => this.__on_select(ref.get_text()) },
                { left_icon: LoopIcon, text: 'Shivam Siddaiya', on_select: ref => this.__on_select(ref.get_text()) },
                { left_icon: LoopIcon, text: 'Aditya Rai', on_select: ref => this.__on_select(ref.get_text()) },
                { left_icon: LoopIcon, text: 'Andrew Choi', on_select: ref => this.__on_select(ref.get_text()) },
                { left_icon: LoopIcon, text: 'Shrey Joshi', on_select: ref => this.__on_select(ref.get_text()) },
            ]
        }
    }
    ...
    */
    render = () => <div className='global-header'>
        ...
        <div className='tiktok-img'>
            ...
            <div className='tiktok-text'><label><strong><Link to={"/"} style={{textDecoration: "none", color: "black"}}>Surfa</Link></strong></label></div>
        </div>
        {/* Search container */}
        <div className='searcher' title='Search something here.'>
            {/* Input representation */}
            <input type='text' placeholder='Search students' onChange={this.__on_input_value_changed} ref={this.field} />
